...
if ($odjava == 1) {
    ...
    Sesija::obrisiSesiju();
    $sql_script_odjava = "UPDATE korisnik SET ulogiran = '" . 0 . "' WHERE korisnicko_ime = '" . $_SESSION["korisnik"] . "'";
    $mysql->selectDB($sql_script_odjava);
...
<html lang="hr">
    <head>
        ...
        <meta name="kljucne_rijeci" content="projekt, administrator, početna" />
    ...
    <body>
        ...
        <nav>
            <ul>
                ...
                <li>
                    <a href="index_admin.php?odjava=0">Admin tools</a>
                </li>
                <li>
