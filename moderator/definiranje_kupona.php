...
if($zastavica == 1) {
    $sql_script_kupon = "UPDATE kupon SET podrucje = '" . $podrucje . "', bodovi = '" . $bodovi . "', aktivanOd = '" . $aktivan_od . "', aktivanDo = '" . $aktivan_do . "' WHERE kupon_id LIKE '" . $kupon . "'";
    $rez = $mysql->updateDB($sql_script_kupon);
}
...
<html lang="hr">
    <head>
        <title>Definiranje kupona</title>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="naslov" content="Popis podrucja" />
        <meta name="kljucne_rijeci" content="projekt, moderator, definiranje_kupona" />
    ...
    <body>
        ...
        <nav>
            <ul>
                ...
                <li>
                    <a href="definiranje_kupona.php" class="active">Definiranje kupona</a>
                </li>
                <li>
        ...
        <section>
            ...
            <form id="novi" class="novi_proizvod" method="POST" name="novi_proizvod" action="<?php echo $_SERVER["PHP_SELF"] ?>">
                ...
                <input type="text" id="bodovi" name="bodovi" size="15" maxlength="15" placeholder="Bodovi" required="required"><br><br>
                <label for="od">Aktivan od:</label>
                <input type="date" id="od" name="od"/><br><br>
                <label for="do">Aktivan do:</label>
                <input type="date" id="do" name="do"/><br><br><br>
