...
$sql_upit_tema = "SELECT izgled FROM podrucje WHERE podrucje_id LIKE '" . $podrucje . "'";
$rezeze = $mysql->selectDB($sql_upit_tema);
$tema = "";

while($row = $rezeze->fetch_assoc()) {
    $tema = $row["izgled"];
}
if($tema == '1') {
    $izlaz_teme = "css/antglesic_red.css";
}
if($tema == '2') {
    $izlaz_teme = "css/antglesic_orange.css";
}
if($tema == '3') {
    $izlaz_teme = "css/antglesic_green.css";
}
    ...
    <body>
        ...
        <nav>
            <ul>
                ...
                <li>
                    <a href="index_novi.php?odjava=0">Izbornik funkcionalnosti</a>
                </li>
                <li>
